 ...
 */
function gojzer_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['gojzer_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('gojzer sample setting'),
  '#default_value' => theme_get_setting('gojzer_example'),
